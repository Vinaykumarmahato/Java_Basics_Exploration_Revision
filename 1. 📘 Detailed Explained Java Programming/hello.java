 ...
 * 
 * Transistors, acting as switches, transition between low and high states.
 ...
 * transistors ka use hota hai. Transistors electricity ka flow control karne
 ...
 * 
 * Transistors switches ki tarah kaam karte hain aur low aur high states ke
 ...
 * language, and the computer gets it directly.
 * 
 * But remembering lots of these codes is hard. That's where Assembly language
 * comes in. Instead of using numbers, we use words like "add" for adding and
 ...
 * 
 * Assembly language is not very easy for us, though. So, we made another
 ...
 * called a Compiler to change our high-level language into the computer's
 * language.
 * 
